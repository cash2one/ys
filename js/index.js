require([
    ...
    $(function () {
        ...
        $('#j-page').fullpage({
            ...
            afterLoad: function (anchorLink, index) {
                ...
                window.rxStream.__events.pageExchange.begin(index);
            },
            onLeave: function (index, direction) {
                if (index == '3') {
                    pc_line(0);
                }
                window.rxStream.__events.pageExchange.end();
            }
        });
        //绾挎潯
    ...
    function mouse(mouse_obj) {
        ...
        var index_xh = setInterval(function () {
                page02bg($(".m-page-02 .page-bg-03"), -100, //X杞�
                    40, //Y杞�
                    20, //X杞寸Щ鍔ㄨ窛绂�
                    9, //Y杞寸Щ鍔ㄨ窛绂�
                    20, //X杞撮€熷害
                ...
                page02bg($(".m-page-02 .page-bg-02"), -90, //X杞�
                    40, //Y杞�
                    20, //X杞寸Щ鍔ㄨ窛绂�
                    20, //Y杞寸Щ鍔ㄨ窛绂�
                    10, //X杞撮€熷害
                ...
                page02bg($(".m-page-02 .page-bg-01"), -90, //X杞�
                    40, //Y杞�
                    20, //X杞寸Щ鍔ㄨ窛绂�
                    9, //Y杞寸Щ鍔ㄨ窛绂�
                    10, //X杞撮€熷害
